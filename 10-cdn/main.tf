resource "aws_cloudfront_distribution" "web_cdn" {
  origin {
    domain_name              =  "web-${var.environment}.${var.zone_name}"#web-dev.sai343s.online
  ...
  aliases = ["web-${var.common_tags.Component}.${var.zone_name}"]#web-cdn.sai343s.online
...
module "records" {
  ...
  records = [
    {
      name    = "web-cdn" #web-cdn.sai343s.online
      type    = "A"
